...
class Kirki_Box_Model_Control extends WP_Customize_Control {
	...
	protected function content_template() {
		...
		var labelsL10n = {
			margin: '<?php esc_html_e( 'Margin', 'kirki-pro' ); ?>',
			border: '<?php esc_html_e( 'Border', 'kirki-pro' ); ?>',
			padding: '<?php esc_html_e( 'Padding', 'kirki-pro' ); ?>',
			'margin-top': '<?php esc_html_e( 'Margin Top', 'kirki-pro' ); ?>',
			'margin-right': '<?php esc_html_e( 'Margin Right', 'kirki-pro' ); ?>',
			'margin-bottom': '<?php esc_html_e( 'Margin Bottom', 'kirki-pro' ); ?>',
			'margin-left': '<?php esc_html_e( 'Margin Left', 'kirki-pro' ); ?>',
			'border-top': '<?php esc_html_e( 'Border Top', 'kirki-pro' ); ?>',
			'border-right': '<?php esc_html_e( 'Border Right', 'kirki-pro' ); ?>',
			'border-bottom': '<?php esc_html_e( 'Border Bottom', 'kirki-pro' ); ?>',
			'border-left': '<?php esc_html_e( 'Border Left', 'kirki-pro' ); ?>',
			'padding-top': '<?php esc_html_e( 'Padding Top', 'kirki-pro' ); ?>',
			'padding-right': '<?php esc_html_e( 'Padding Right', 'kirki-pro' ); ?>',
			'padding-bottom': '<?php esc_html_e( 'Padding Bottom', 'kirki-pro' ); ?>',
			'padding-left': '<?php esc_html_e( 'Padding Left', 'kirki-pro' ); ?>',
		};
		#>
